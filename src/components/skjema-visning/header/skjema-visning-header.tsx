...
export function SkjemaVisningHeader(props: SkjemaVisningHeaderProps) {
	const tittelTekst = props.erGjeldende
		? 'Gjeldende vedtak'
		: 'Tidligere vedtak';

	const vedtakBilde = props.erGjeldende
		? gjeldendeVedtakBilde
		: tidligereVedtakBilde;
	...
	return (
		<div className="skjema-visning-header">
			...
			<div className="skjema-visning-header__vedtak">
				...
				<Systemtittel tag="h1" className="skjema-visning-header__tittel">{tittelTekst}</Systemtittel>
				<span className="skjema-visning-header__seperator"/>
			</div>
		</div>
	);
