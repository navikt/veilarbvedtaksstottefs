...
import { mergeMedDefaultOpplysninger } from '../../../../util/skjema-utils';
...
function Opplysninger() {
	...
	return (
		<SkjemaBolk className="opplysninger-skjema-bolk" id="opplysninger-scroll-to" tittel={opplysningerTittel}>
			<div className="opplysninger">
				...
				<div className="opplysninger__innhold">
					<SkjemaGruppe
						...
						feil={
							errors.opplysninger && (
								<SkjemaelementFeilmelding>{errors.opplysninger}</SkjemaelementFeilmelding>
							)
						}
					>
