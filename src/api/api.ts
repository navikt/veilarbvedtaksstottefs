import { fetchJson, FetchResponse, fetchWithChecks, useFetch } from './utils-old';
...
import { Veileder } from './veilarbveileder';
import { MalformData, MalformType } from './veilarbperson';
import Oppfolging from './veilarboppfolging';
import { DialogMelding, SystemMelding } from './veilarbvedtaksstotte/meldinger';
import { BeslutterprosessStatusData } from './veilarbvedtaksstotte/utkast';
import { ArenaVedtak } from './veilarbvedtaksstotte/vedtak';
import { Vedtak } from './veilarbvedtaksstotte';
import { ALL_TOGGLES, FeatureToggles } from './veilarbpersonflatefs';
...
export const useFetchFeatures = () => {
	...
	return useFetch<FeatureToggles>(`${FEATURE_TOGGLE_URL}/?${toggles}`, { credentials });
};
