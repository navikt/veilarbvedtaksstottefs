				...
				<Accordion.Item>
					...
					>
						{gammelnavskResultater.length == 1 ? (
							...
							<>{gammelnavskResultater.length} ord i Begrepskatalogen</>
						)}
					</Accordion.Header>
					<Accordion.Content>
							...
							{gammelnavskResultater.map((gammelnavsk, i) => (
								<Accordion.Item key="">
									...
									<Accordion.Content className="gammelnavskAccordionContent">
										...
										<p className="firstLetter">{gammelnavsk._source.content.clean_definisjon}</p>
										...
										<Link target="_blank" href={'https://data.nav.no/begrep/' + gammelnavsk._id}>
											Åpne i Berepskatalogen
											<ExternalLink />
										</Link>
									</Accordion.Content>
								</Accordion.Item>
